...
const ChapterListTab = ({
  ...
  const ChapterCard = ({ chapter, index }) => {
    ...
    return (
      <Button
        onClick={() => router.push(`/my-works/${storyId}/write/${chapter.id}`)}
        fullWidth
          ...
          <Grid xs={8} spacing={0} container justifyContent="flex-start">
            <Grid
              ...
              <Typography
                ...
                sx={{
                  paddingRight: '2em',
                  fontWeight: isDraft ? 'normal' : 'bold',
                }}>
            ...
            <Popover
              ...
              <Grid container direction="column">
                <Button
                  variant="text"
                  color="primary"
                  onClick={() => onPreview({ chapterId: chapter.id })}>
                  Xem trước
                </Button>
                {chapter.is_draft ? (
                  <Button
                    ...
                    color="primary"
                    onClick={() =>
                      onPublish({ chapterId: chapter.id, isPublish: true })
                    }>
                    Đăng tải
                  </Button>
                  ...
                  <Button
                    ...
                    color="primary"
                    onClick={() =>
                      onPublish({ chapterId: chapter.id, isPublish: false })
                    }>
                    Gỡ đăng tải
                  </Button>
                ) : (
