...
import { Button, Grid, MenuItem, Stack, Switch, Tab, Tabs, TextField, Typography } from '@mui/material';
            ...
            <div>
                <form noValidate onSubmit={(e) => { e.preventDefault(); handleCreate() }}>
                    ...
                    >
                        ...
                        <Tabs value={tabValue} onChange={handleChangeTab} aria-label="disabled tabs example">
                            <Tab label="Chi tiết truyện" />
                            <Tab label="Mục lục" />
                        </Tabs>
